...
//adding background color:rgb(200, 45, 255)  to the squares
const startButton = document.getElementById("reset");

startButton.addEventListener("click", function(){
    this.innerHTML="New Colors";
    
  //setting background color for each square  
...
//assigning a random rgb value from one of the square values to the header
...
//add event listener to squares to disapper or change all squares color
